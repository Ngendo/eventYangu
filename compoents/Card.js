...
const arrayIcon=[<AllOutIcon fontSize="small" className={style}/>,<DoneIcon FontSize="small"/>,<EcoIcon fontSize="small" className={style}/>,<LockIcon fontSize="small" className={style}/>]
